...
function sideBar() {
  return (
    <div class="flex text-gray-900">
      <aside class="flex h-screen w-[59px] flex-col items-center border-r border-primary-blue bg-primary-blue">
        <nav class="flex flex-1 flex-col  pt-1">
          <a href="home" class="text-white group relative p-5 hover:bg-white">
            <svg
              ...
              stroke-width="1.5"
              stroke="currentColor"
              class="h-6 w-6 stroke-current group-hover:text-black transform motion-safe:hover:scale-125"
              width="24"
              height="24"
            >
              <path
          ...
          <a
            href="new-order"
            class="text-white group relative p-5 hover:bg-white"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
          ...
          <a href="my-docs" class="group relative p-5 hover:bg-white">
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
              class="h-6 w-6 text-white  group-hover:text-black transform motion-safe:hover:scale-125"
              stroke="currentColor"
            >
              <path
          ...
          >
            <svg
              ...
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
              class="h-7 w-7 stroke-current group-hover:text-black transform motion-safe:hover:scale-125"
            >
          ...
          <a href="more" class="text-white group relative p-5 hover:bg-white">
            <svg
              width="28"
              height="27"
              viewBox="0 0 28 27"
